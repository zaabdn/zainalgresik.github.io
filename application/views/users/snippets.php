...
<html>
   <head>
      <title>MLIJO | Food and Culinary </title>
      <meta charset="utf-8">
      ...
      <link rel="shortcut icon" type="image/x-icon" href="<?=base_img()."icon/groceries-bag.png"?>" >
            ...
            <div class="header-content"> 
               ...
               <nav class="site-nav">
                  <ul class="clean-list site-links">
                      ...
                      <a href="<?=site_url('index.php/snippets')?>" class="btn btn-white">Cari Makanan ? disini</a>
      ...
      <div class="content-box">
         ...
         <section class="section section-destination" style="padding-top: 40px">
            ...
            <div class="section-title">
               <div class="container">
                  <h2 class="title">Telusuri pengalaman berbelanja disetiap mlijo yang ada</h2>
               </div>
            </div>
